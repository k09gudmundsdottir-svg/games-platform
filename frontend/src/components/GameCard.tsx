        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center gap-4 text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-body">{players} players</span>
            </div>
            <div className="flex items-center gap-1">
              <Clock className="w-3.5 h-3.5" />
              <span className="text-xs font-body">{duration}</span>
            </div>
            <div className="flex items-center gap-1 ml-auto">
              <Star className="w-3.5 h-3.5 fill-primary text-primary" />
              <span className="text-xs font-body font-medium text-foreground">{rating}</span>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 rounded-lg bg-secondary text-secondary-foreground font-display font-semibold text-sm hover:bg-primary hover:text-primary-foreground transition-all duration-300"
            >
              Play Now
            </button>
            <button
              onClick={() => navigate(`/play/${slug}`)}
              className="px-3 py-2.5 rounded-lg bg-secondary/60 text-muted-foreground font-display font-medium text-sm hover:text-foreground hover:bg-secondary transition-all duration-300 border border-border/30"
            >
              Preview
            </button>
          </div>
